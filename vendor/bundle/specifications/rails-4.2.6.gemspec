...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionview>, ["= 4.2.6"])
      s.add_runtime_dependency(%q<activemodel>, ["= 4.2.6"])
      s.add_runtime_dependency(%q<activerecord>, ["= 4.2.6"])
      s.add_runtime_dependency(%q<actionmailer>, ["= 4.2.6"])
      s.add_runtime_dependency(%q<activejob>, ["= 4.2.6"])
      s.add_runtime_dependency(%q<railties>, ["= 4.2.6"])
      ...
      s.add_dependency(%q<activemodel>, ["= 4.2.6"])
      s.add_dependency(%q<activerecord>, ["= 4.2.6"])
      s.add_dependency(%q<actionmailer>, ["= 4.2.6"])
      s.add_dependency(%q<activejob>, ["= 4.2.6"])
      s.add_dependency(%q<railties>, ["= 4.2.6"])
